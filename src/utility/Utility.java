...
public class Utility {
    public static boolean isDateInputValid(String date) {
        // Found the following date regex at: https://stackoverflow.com/questions/20231539/java-check-the-date-format-of-current-string-is-according-to-required-format-or#:~:text=DateFormat%20formatter%20%3D%20new%20SimpleDateFormat(%22,in%20different%20format%20or%20invalid.%20%7D
